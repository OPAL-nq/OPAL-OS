...
export function ProblemSolutionSection() {
  return (
    <section className="py-16 sm:py-24 border-t border-white/5 bg-[#0D0D0D]/50 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-[#141414] border border-red-500/20 space-y-6 relative overflow-hidden">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-400 shrink-0">
                <XCircle className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-white">Le Trader Retail Isolé</h3>
            ...
            <div className="p-3.5 rounded-xl bg-red-500/5 border border-red-500/10 text-[11px] text-red-300/80 text-center font-medium">
              Résultat : Des milliers d'euros perdus en frais de réinitialisation et un sentiment de stagnation.
            </div>
          </div>

          {/* Box 2: The OPAL Intensive Way (Professional & Systematic) */}
          <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-b from-[#141414] to-[#0f1f11] border border-[#39FF14]/40 space-y-6 relative overflow-hidden shadow-[0_0_35px_rgba(57,255,20,0.1)]">
            <div className="absolute top-0 right-0 bg-[#39FF14] text-black text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-bl-xl shadow-md">
              Méthode OPAL
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">L'Approche OPAL Intensive</h3>
            ...
            <div className="p-3.5 rounded-xl bg-[#39FF14]/10 border border-[#39FF14]/20 text-[11px] text-[#39FF14] text-center font-bold">
